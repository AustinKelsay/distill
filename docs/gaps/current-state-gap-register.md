...
- Status: implemented and green for the hermetic desktop provider-parity and Attempt-history/renormalize caller seams, and for continuous core rebuild CI enforcement (#46); packaged real-provider, release, and human residuals remain explicit
