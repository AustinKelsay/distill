...
- Status: implemented and exact-head green for the hermetic desktop provider-parity, Attempt-history/renormalize caller, and independent Source-detection caller (#47) seams; continuous core rebuild CI enforcement (#46) is green; packaged real-provider, release, and human residuals remain explicit
